            ...
            {:else}
              <div class="p-4 space-y-3">
                ...
                {#each $notificationHistory as notification, index (notification.id)}
                  ...
                  >
                    <div
                      class="theme-icon-mask w-5 h-5 shrink-0 mt-0.5"
                      style="background-color: {getNotificationIconColor(
                        notification.type
                      )}; -webkit-mask-image: url('{getNotificationIcon(
                        notification.type
                      )}'); -webkit-mask-size: contain; -webkit-mask-position: center; -webkit-mask-repeat: no-repeat; mask-image: url('{getNotificationIcon(
                        notification.type
                    ...
                    <div class="flex-1 min-w-0">
                      <p
                        class="text-sm font-medium text-text-primary leading-relaxed mb-1"
                      >
              ...
              <div class="p-4 space-y-3">
                ...
                {#each $deferredTasks as task, index (task.id)}
                  ...
                  >
                    <div
                      class="theme-icon-mask w-5 h-5 shrink-0 mt-0.5"
                      style="background-color: {getTaskStatusIconColor(
                        task.status
                      )}; -webkit-mask-image: url('{getTaskStatusIcon(
                        task.status
                      )}'); -webkit-mask-size: contain; -webkit-mask-position: center; -webkit-mask-repeat: no-repeat; mask-image: url('{getTaskStatusIcon(
                        task.status
                      )}'); mask-size: contain; mask-position: center; mask-repeat: no-repeat;"
                      role="img"
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      {#if task.status === 'running' && task.progress > 0}
                        <div class="w-full bg-border rounded-full h-1.5 mb-2">
                          <div
                      ...
                      {#if task.logs && task.logs.length > 0}
                        <details class="mt-2">
                          <summary
                            class="text-xs text-text-secondary cursor-pointer hover:text-text-primary"
                          >
