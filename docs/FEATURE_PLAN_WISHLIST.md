...
- I can **add a game to my wishlist** from the store page or from search results so I don’t have to search again later.
- I can **see my wishlist** in one place (Discover) and open any game’s store page from there.
- I can **remove a game from my wishlist** from the store page or from the wishlist section.
- My wishlist **persists** across app restarts (stored on disk like “recently played”).
